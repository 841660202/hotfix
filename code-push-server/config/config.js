 ...
 * @LastEditTime: 2019-09-26 09:22:36
 * @Descripttion:
 */
var os = require('os');
...
config.development = {
  ...
  local: {
    ...
    storageDir: process.env.STORAGE_DIR || "/Users/chenhailong/development/rn/hotfix/code-push-server/_storage",
    // Binary files download host address which Code Push Server listen to. the files storage in storageDir.
    downloadUrl: process.env.LOCAL_DOWNLOAD_URL || "http://hailong.vaiwan.com/download", // TODO 修改下载链接
  ...
  jwt: {
    ...
    tokenSecret: process.env.TOKEN_SECRET ||'54328FFD24C16CB78194A35C04F6C4A7D7655D068E159C91F9E15A73624FECE8'
  },
  common: {
    /*
    ...
    dataDir: '/Users/chenhailong/development/rn/hotfix/code-push-server/_data',
